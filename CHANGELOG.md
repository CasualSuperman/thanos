...
- [#1632](https://github.com/thanos-io/thanos/issues/1632) Removes all duplicates checks on Thanos Querier; Made Store Gateway compatible with older Querier versions.
 NOTE: `thanos_store_node_info` metric is now per `external_labels` and `store_type` now.
